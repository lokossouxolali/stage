                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select @error('secteur_activite') is-invalid @enderror" 
                                        ...
                                        <option value="Marketing" {{ old('secteur_activite') == 'Marketing' ? 'selected' : '' }}>Marketing</option>
                                        <option value="Ressources Humaines" {{ old('secteur_activite') == 'Ressources Humaines' ? 'selected' : '' }}>Ressources Humaines</option>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="4" 
                                      placeholder="Décrivez l'entreprise, ses activités, sa mission...">{{ old('description') }}</textarea>
                        </div>
                        @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
